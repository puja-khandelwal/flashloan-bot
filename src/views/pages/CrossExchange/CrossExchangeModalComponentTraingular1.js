...
function CrossExchangeModalComponentTraingular1(props) {
  const {
    exchangeModalClose,
    crossExchangeData,
    onTradeArbitrage,
  ...
  const SafeGasPriceEstimate = async () => {
    try {
      ...
      setreturnedValue(fromWeiDecimals(amountGetoutFunCA, 18));
      console.log(
...
export default CrossExchangeModalComponentTraingular1;
